...
def haya2interpix(ix,iy,pixdim,dirh="/home/kawahara/lpsat/pixsim/data/",file="v_flatn.fits",figsw=0):
    #ix,iy: center pixel
...
def read_intrapix(filex,filey,spixdim,dirh="/home/kawahara/lpsat/pixsim/data/"):
